% Derive the linearised robot equation for 1-Segment robot
...
Q = [  f1*r*cos(theta1/2) - f2*r*cos(theta1/2) + f1*l*sin(theta1/2) + f2*l*sin(theta1/2)
 f1*r*cos(theta2/2) - f2*r*cos(theta2/2) + f1*l*sin(theta2/2) + f2*l*sin(theta2/2)
 f1*r*cos(theta3/2) - f2*r*cos(theta3/2) + f1*l*sin(theta3/2) + f2*l*sin(theta3/2)
 f1*r*cos(theta4/2) - f2*r*cos(theta4/2) + f1*l*sin(theta4/2) + f2*l*sin(theta4/2)
...
dot_t_ee = (x_ee*dot_y_ee-y_ee*dot_x_ee)/(x_ee^2+y_ee^2);
